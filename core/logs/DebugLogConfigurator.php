...
/**
 * Contains class DebugLogConfigurator
 * 
 * @version	$Id: DebugLogConfigurator.php Oct 4, 2012 18:40:21 PM Z slava.poddubsky $
 * @package	SimpleMVC
 * @subpackage	Core
 ...
 */
class DebugLogConfigurator implements LoggerConfigurator {
